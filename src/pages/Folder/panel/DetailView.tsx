// src/components/DetailsTabPanel.tsx
...
// Define a minimal interface for apiData based on its usage
	...
	return (
		<>
			...
			{selectedItem.type === "serviceDomain" ? (
					...
					{apiData && !loading && !error && (
						<Stack spacing={0.5}>
							<Typography
								...
								component="div"
								sx={{ mt: 1 }}>
								Service Domain Specifics
							</Typography>
							<DetailItem label="Display Name" value={apiData.displayName} />
							<DetailItem
								label="Role Definition"
								value={apiData.roleDefinition}
							/>
							<DetailItem
								label="Executive Summary"
								value={apiData.executiveSummary}
							/>
							<DetailItem
								label="Examples of Use"
								value={apiData.examplesOfUse}
							/>
							<DetailItem label="API Status" value={apiData.apiStatus} />
							<DetailItem label="Status" value={apiData.status} />
						</Stack>
					)}
				...
				<Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>
					Detailed API information! is typically available for Service Domains.
				</Typography>
			)}
		</>
	);
