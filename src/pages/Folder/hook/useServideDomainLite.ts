...
const useServiceDomainLiteDetails = (
		...
		const fetchData = async () => {
			...
			try {
				const response = await axios.get<ApiServiceDomainDetailResponse>(
					`https://bian-modelapi-v4.azurewebsites.net/v2/ServiceDomainByUID/${serviceDomainUID}`
				);
...
export default useServiceDomainLiteDetails;
